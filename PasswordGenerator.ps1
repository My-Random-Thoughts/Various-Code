...
#region Form Scripts
    ...
    $passgenForm_Cleanup_FormClosed = {
        ...
        $CloseButton.Remove_Click($CloseButton_Click)
...
#region Form Controls
    ...
    # TAB 1 - Password Generation Options
    ...
    $CloseButton.Location              = '307, 385'
    $CloseButton.Size                  = ' 75,  25'
    $CloseButton.Text                  = 'Close'
    $CloseButton.TabIndex              = '97'
    $passgenForm.CancelButton          = $CloseButton
    $passgenForm.Controls.Add($CloseButton)
